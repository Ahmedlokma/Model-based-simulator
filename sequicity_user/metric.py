...
class GenericEvaluator:
    def __init__(self, result_path):
        self.file = open('/Users/ahmedlokma/Desktop/user-simulator-master/sequicity_user/results/Guc2.csv','r')
        # self.file = open('/Users/ahmedlokma/Desktop/user-simulator-master/sequicity_user/elephant.csv','r')
        # # self.file = open('/Users/ahmedlokma/Desktop/user-simulator-master/sequicity_user/results/trainmodel.csv','r')
        # print(result_path)
        # time.sleep(20)
        # self.file = open('/Users/ahmedlokma/Desktop/user-simulator-master/sequicity_user/results/Guc.csv','r')
...
class CamRestEvaluator(GenericEvaluator):
    ...
    def match_metric(self, data, sub='match',raw_data=None):
        ...
        # print(data)
            ...
            for i, row in enumerate(data):
                nltk_tokens = nltk.word_tokenize(data[i]['response'])
                nltk_tokens2 = nltk.word_tokenize(data[i]['generated_response'])
    ...
    def success_f1_metric(self, data, sub='successf1'):
        ...
        for dial_id in dials:
            ...
            for turn_num, turn in enumerate(dial):
                # print(turn['generated_response'])
                # print(turn['response'])
                gen_response_token = turn['generated_response'].split()
                print(gen_response_token)
            ...
            for req in truth_req:
                if req not in gen_req:
                    fn += 1
                    print("HYUCBDSJBJHDSBVDCUYVDUYC")
